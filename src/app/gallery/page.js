        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            {visibleImages.map((image, index) => (
              ...
              >
                <div
                  className="absolute inset-0 bg-gradient-to-br from-red-600/20 to-black/50 
                ...
                >
                  ...
                  >
                    <span
                      className="text-red-400 font-synth text-sm uppercase tracking-wider
          ...
          {selectedImage !== null && (
            ...
            >
              ...
              <div className="relative group max-h-[90vh] max-w-[90vw]">
                ...
                />
                <div
                  className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent 
              ...
              {/* Image Counter */}
              <div
                className="absolute bottom-4 left-1/2 -translate-x-1/2 text-red-600 font-synth
